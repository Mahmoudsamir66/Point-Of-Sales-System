                ...
                <section class="content">
                    <div class="card card-info user-info">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fas fa-book-reader text-primary ml-2"></i>تعديل اسم المخزن
                            </h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="form-horizontal" action="{{ route('stores.edit.update',$store->id) }}" method="POST"
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="#" value="{{$store->name}}" name="name">
                                    </div>
                                </div>
                            </div>
                            <!-- /.card-body -->
