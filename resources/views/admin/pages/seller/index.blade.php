    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark"><i class="fas fa-edit text-info ml-2"></i> بيع منتجات</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
            ...
            <div class="col-md-8">
                <section class="content">
                    <div class="card card-info user-info">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="form-horizontal" action="{{ route('admin.seller.product.store') }}" method="POST"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label for="" class="col-sm-3 control-label">اسم المشتري</label>
                                    <div class="col-sm-9">
