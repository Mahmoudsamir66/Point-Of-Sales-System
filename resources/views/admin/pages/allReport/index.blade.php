                ...
                <section class="content">
                    <div class="card card-info user-info">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fas fa-book-reader text-primary ml-2"></i> اضافه  فاتوره
                            </h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <div class="col-lg-12">
                            <form action="{{ route('admin.allReport.reportIndex') }}" method="POST" class="form-horizontal"
                                >
                                @csrf
