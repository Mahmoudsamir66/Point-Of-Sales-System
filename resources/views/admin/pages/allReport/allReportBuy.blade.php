        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <table class="table table-hover">
                    <thead>
                    <tr>
                        <th scope="col">رقم الفاتوه</th>

                        <th scope="col">اسم صاحب الفاتوه</th>
                        <th scope="col">اسم القائم بالفاتوره</th>
                    ...
                    @foreach($reports as  $key=>$report)
                        <tr>
                            ...
                            <td>{{$report->date}}</td>
                            <td><a href="{{route('reports.all.show.buy',$report->id)}}" class="btn btn-warning"><i
