<footer class="main-footer non-distable ">
    <strong>Copyright &copy; 2021-2022 <a href="#">POS</a>.</strong>
    All rights reserved.
...
<script src="{{asset('public/assets/plugins/jqvmap/maps/jquery.vmap.world.js')}}"></script>
<!-- jQuery Knob Chart -->
